...
public struct WaveCatalog: Codable, Equatable, Sendable {
    ...
    public func validate() throws {
        ...
        guard guardInitialTarget > 0, guardMaximumTarget >= guardInitialTarget, guardGrowthIntervalSeconds > 0, guardSpawnIntervalTicks > 0, guardSpawnRadius > 0, sensorSpawnIntervalTicks > 0, sensorSpawnRadius > 0 else { throw WaveCatalogError.invalidDefinition }
    }
}

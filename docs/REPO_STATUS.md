...
| Phase | Status |
| --- | --- |
| P2 device | Mechanical + **live extracts**: Louisville (`7c400e7`) + Tulsa (`44a204f` dynamic stick) — receipts in `docs/device_evidence/`; **ART eyes + full a11y/audio listening still open** |
...
1. **Operator:** complete [`ART_DEVICE_QA_CHECKLIST.md`](ART_DEVICE_QA_CHECKLIST.md) pass/fail for tip **`44a204f`** (live extracts filed); optional background/haptics/VoiceOver notes

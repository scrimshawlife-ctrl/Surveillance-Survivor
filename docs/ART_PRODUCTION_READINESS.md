...
**As of:** 2026-07-25 · tip `6a06fb1` · `make assets-check` green · full perception package [`ART_QA_PERCEPTION_AUDIT.md`](ART_QA_PERCEPTION_AUDIT.md) (`ship_gate: ART_EVIDENCE_INSUFFICIENT` until device).

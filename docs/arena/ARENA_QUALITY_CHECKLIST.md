...
| Tip (device-smoke) | **`5dc8a05`** — 1.5× arenas + satellite streets/zoom; dual-launch PASS |
...
| Physical device smoke | **PASS** on **`5dc8a05`** (1.5× arenas + satellite streets) — deploy + dual-launch (`00008150-000A6C120CB8401C`) |

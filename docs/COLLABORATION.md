...
| Prabu | topic branches off `main` | **#160 merged** (animation integration); optional residual per handoff leftovers | [`PRABU_HANDOFF_2026-08-05_animation_isolation.md`](PRABU_HANDOFF_2026-08-05_animation_isolation.md); do not resume `agent/prabu-openclaw` |

.PHONY: generate version-check privacy-check assets-check audio-check weapon-vfx-check animation-check director-check city-state-check build-engine-check coordination-check story-check test build simulator-test simulator-smoke emulator-test device-smoke validate
...
validate: version-check privacy-check assets-check audio-check weapon-vfx-check animation-check director-check city-state-check build-engine-check coordination-check story-check test simulator-test

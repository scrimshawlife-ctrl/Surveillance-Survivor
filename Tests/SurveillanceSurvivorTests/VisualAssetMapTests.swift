...
@Test func visualAssetMapTerrainRolesCoverCampaignLevels() {
    ...
    #expect(VisualAssetMap.terrainRole(for: .tulsa) == .tulsaTerrainRouteArterial)
    ...
    #expect(VisualAssetMap.terrainRole(for: .atlanta) == .atlantaTerrainFreewayTrench)
    #expect(VisualAssetMap.secondaryTerrainRole(for: .wichita) == .wichitaTerrainPrairieEdge)
    #expect(VisualAssetMap.secondaryTerrainRole(for: .atlanta) == .atlantaTerrainBeltlineLoop)
    #expect(VisualAssetMap.usesParkingLotMarks(for: .wichita))
    #expect(!VisualAssetMap.usesParkingLotMarks(for: .newYorkCity))
    ...
    #expect(VisualAssetMap.skylineRole(for: .tulsa) == .tulsaSkyline)
    ...
    #expect(VisualAssetMap.skylineRole(for: .atlanta) == .atlantaSkyline)
}
